...
Next, ARO receives an observation of $0$ and creates the rules
$1a \rightarrow 0: 100\%$, $0b, 1a \rightarrow 0: 100\%$, and $0a, 0b,
1a \rightarrow 0: 100\%$. These may seem redundant, but they are all
stored independently so that each of their probabilities may change
independently in the future. With $prevSeq$ set to $[1a]$, the agent
may now capitalize on its expert knowledge. Using $prevSeq$, the agent
finds $a$ is the best move with an expected value of $1$ because of
the expert rule $1a, 0b \rightarrow 1: 100\%$. This beats move $b$, with an expected value the same as the heuristic at $5$. ARO then takes move $b$ to reach the goal.
