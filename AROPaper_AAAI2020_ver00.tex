...
\begin{algorithmic}[1]
	\Function{EV}{Episode[] $episodes$, Observation $o$}
		...
		\For{$a$ in $\alpha$}
			...
			\State $nextRuleSet =$ \Call{GetRuleSet}{$nextSeq$} % Note: This looks awful because LaTeX spreads out spacing. This will need the full page to loook correct
			\If{$nextRuleSet$ is empty}
