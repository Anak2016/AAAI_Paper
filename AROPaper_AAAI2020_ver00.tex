...
this paper, we will define a data structure known as a rule that
stores patterns of cause and effect. These rules can easily embed
expert knowledge on causal relationships. We will then present ARO, an
algorithm for learning rules and using rules to navigate data sparse
